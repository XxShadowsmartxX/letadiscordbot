...
module.exports = {
    ...
    execute(message, args){
        ...
        const embed = new Discord.MessageEmbed()
            .setColor('020f73')
            .setTitle(`Enrollment is Open!\n\nEnrollment Closing Date/Time: ${args[0]}`)
