...
module.exports = {
    ...
    execute(message, args){
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .addField('Enrollment Closing Date', `${args[0]} ${args[1]} ${args[2]} ${args[3]} ${args[4]}`, true)
        message.channel.send(embed);

        const mst = message.client.channels.cache.get('710960625135779911')
        mst.send(`**Enrollopen** command used by **${message.author.username}** in ${message.channel}.\nCommand usage: **${message.content}**`)
