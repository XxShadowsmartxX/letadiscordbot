...
module.exports = {
    ...
    execute(message, args){
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .setDescription(`To ${args[0]},\n\nYou have been **permanently blacklisted** by the ALETA Administration. More information regarding your blacklist can be found on the **'BLACKLISTS'** sheet which sits on the ALETA database.\nThis type of blacklist is **not appealable** and cannot be removed.\n\n**Regards,**\nAigio Law Enforcement Training Academy Administration`)
            ...
            message.channel.send(`${message.author}, Permanent Blacklist notice successfully sent to ${args[0]}.`);
