...
module.exports = {
    ...
    execute(message, args){
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .setDescription(`To ${args[0]},\n\nYou have been **permanently blacklisted** by the ALETA Administration. More informatioon regarding your blacklist can be found on the **'BLACKLISTS'** sheet which sits on the ALETA database.\nThis sort of blacklist is **not appealable**\n\n**Regards,**\nAigio Law Enforcement Training Academy Administration`)
