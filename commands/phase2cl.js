...
module.exports = {
    ...
    execute(message, args){
        ...
        if (message.member.roles.cache.has('705082980770512996')){
            ...
            mst3.send('<@&705083000118837268> <@&705082979784851596>');
