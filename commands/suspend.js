...
module.exports = {
    ...
    execute(message, args){
        ...
        const embed = new Discord.MessageEmbed()
            ...
            message.channel.send(`${message.author}, Suspension notice successfully sent to ${args[0]}.`);
