...
module.exports = {
    ...
    execute(message, args){
        ...
        if (message.member.roles.cache.has('705092415899303977')){
            ...
            message.channel.send(`ALETA Discord Bot made by - S_hadowRBLX`);
            ...
            .addFields(
                ...
                { name: 'Command Used', value: '**-credits**', inline: true },
            ...
            message.channel.send(`${message.author}, Insufficient Permissions for **-credits** command.\n\nRoles required: **Verified**`);
        }
