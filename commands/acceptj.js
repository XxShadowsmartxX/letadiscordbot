...
let username = args[0];
  ...
  message.channel.send(`${message.author}, \`${username}\` has been **accepted** into the CFMP group.`);
            ...
            .addFields(
                ...
                { name: 'Command Used', value: '**-acceptj**', inline: true },
    ...
    let modchannel1 = message.client.channels.cache.get(process.env.modchannel);
        modchannel1.send(modlogs);
            ...
            message.channel.send(`${message.author}, Insufficient Permissions for **-acceptj** command.\n\nRoles required: **Admissions Command** or **Regiment Command**`);
        }
    }
}